...
//			res_type[0] = res_type[2];
			...
			// for function call, set res_type[1] as function return type
			// 1. first look for function in function tab by its name(getChToken(tr, 0))
			res_type[1] = funcTab.get(getChToken(tr, 0)).type;
	...
	private void function(CommonTree tr) {
		...
		//   1) Fill Function Class
		Function func = new Function(getChToken(tr, 0), getChToken(tr, 1));
